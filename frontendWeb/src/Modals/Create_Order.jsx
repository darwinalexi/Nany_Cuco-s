...
export const Create_Order=({onclose })=>{
        ...
        const create_order=async(e)=>{
            ...
            if(datos.referencia<=0 || datos.celular <= 0 || datos.cantidad<=0){
                Swal.fire({
                    title: 'Error!',
                    text: 'Hay valores negativos por favor verique sean coherentes',
                    icon: 'error',
                    confirmButtonText: 'Cerrar'
                  })
                return;
    ...
    <div className="bg-[#707070]  h-full fixed left-0 top-0 w-full bg-opacity-50 z-50">
        <div className="bg-white w-[56%]  overflow-scroll  gap-0 h-[75%] relative top-[15%] left-[23%] rounded-2xl flex justify-center">
            ...
            <div className="relative top-24 w-[45%]">
                <form onSubmit={create_order}>
                    ...
                    <br />
                                    ...
                                    maxDate={new Date()}
                                    showYearDropdown               
                                    className=" w-[155%] placeholder:justify-center p-3 focus:outline-none  border-b border-b-[#dc2e63] border-t border-t-[#dc2e63]   border-r border-r-[#dc2e63]  border-l border-l-[#dc2e63] rounded-xl cursor-pointer"
                                   />
                    <br />
                    <label> Seleccione el usuario que hace el pedido</label>
                    <br/>
                    <select 
                    name="usuario" 
                    onChange={handinputchange}
