...
import { contarproductonotsavalible, estadsisticasultimomes, contarproductosavalible, contarproductosvendidos, contarvalorinvertido, delete_products, register_product, show_for_id_products, show_product_available, show_product_not_available, show_products, show_vendios, update_products, cargarImagen} from '../controller/productos_controller.js'

 const router= Router()

router.get("/productos", show_products)
router.post("/productos", cargarImagen,register_product)
router.put("/productos/:id", cargarImagen,update_products)
